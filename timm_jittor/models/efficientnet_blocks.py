...
from .layers import create_conv2d, drop_path, get_act_layer, BatchNorm2d
...
class ConvBnAct(nn.Module):
    def __init__(self, in_chs, out_chs, kernel_size,
                 ...
                 norm_layer=BatchNorm2d, norm_kwargs=None):
...
class DepthwiseSeparableConv(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, dw_kernel_size=3,
                 ...
                 norm_layer=BatchNorm2d, norm_kwargs=None, drop_path_rate=0.):
    ...
    def execute(self, x):
        ...
        if self.has_residual:
            if self.drop_path_rate > 0.:
                x = drop_path(x, self.drop_path_rate, self.is_train)
            x += residual
        return x
...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, dw_kernel_size=3,
                 ...
                 se_ratio=0., se_kwargs=None, norm_layer=BatchNorm2d, norm_kwargs=None,
...
class CondConvResidual(InvertedResidual):
    ...
    def execute(self, x):
        residual = x
        # CondConv routing
        pooled_inputs = nn.AdaptiveAvgPool2d((1, 1))(x).flatten(1)
